  ...
  generateCommitMessage: publicProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      if (!hasInternet) {
        ...
        console.log(
          "[generateCommitMessage] Online cloud helper removed - using local heuristic fallback",
        )
      }
  ...
  generateSubChatName: publicProcedure
    ...
    .mutation(async ({ input }) => {
      try {
        ...
        console.log(
          "[generateSubChatName] Online cloud helper removed - using deterministic local fallback",
        )
        return { name: getFallbackName(input.userMessage) }
      } catch (error) {
